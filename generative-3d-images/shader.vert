...
void main() {
  ...
  float distortion = -sin(positionVec4.z * frequency + uFrameCount * 0.05) 
  -cos(positionVec4.x * frequency + uFrameCount * -0.05) 
  -cos(positionVec4.y * frequency + uFrameCount * 0.05);
  positionVec4.x -= distortion * aNormal.x * amplitude;
  positionVec4.y += distortion * aNormal.x * amplitude;
  // positionVec4.z += -distortion * aNormal.x * amplitude;
